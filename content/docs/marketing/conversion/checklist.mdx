...
Toda LP, antes de ir pro ar (ou pra tradução, ou pra A/B test), passa por uma revisão humana. Não é "ler de novo procurando erro de digitação" — é confirmar que **a peça faz o que precisa fazer**.

## Checklist de review

### Hero e mensagem
- [ ] Hero comunica valor em menos de 5 segundos
- [ ] Headline passa no [Starving Crowd Test](/docs/marketing/conversion/headlines#halbert-starving-crowd-test) (não poderia ser de qualquer concorrente)
...
### Estrutura
- [ ] Sequência de seções segue lógica persuasiva ([ver](/docs/marketing/conversion/estrutura#lógica-de-persuasão-páginas-importantes))
...
### Voz e copy
- [ ] Copy alinhada com [tom Umbler](/docs/marketing/brand/voice) (mistura 40/25/20/10/5)
- [ ] Sem em-dash (`—`) em copy pt-BR ([regra dura](/docs/marketing/brand/voice#regra-dura-—-sem-em-dash-em-pt-br))
...
3. **A peça passa nas 5 perguntas** do [decision framework](/docs/marketing/brand/decision-framework)
