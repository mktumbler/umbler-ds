...
<Callout type="info">
Esta regra é validada automaticamente pelo `audit-antipatterns.mjs` em arquivos MDX dentro de `content/docs/marketing/`. Para exceções pedagógicas, use a pragma `{/* audit-ignore: em-dash — motivo */}`.
</Callout>
