...
const STATS = [
  ...
  // PREENCHER: substitua por dado real de benchmark
  { n: '< 80 ms', label: 'tempo médio de resposta TTFB' },
  // PREENCHER: substitua por dado real de base de clientes
...
// ── Visuais placeholder (substituir por screenshots reais) ─────────────────────
...
function PainelMock() {
  return (
    <div className="w-full overflow-hidden rounded-2xl border border-border bg-surface shadow-lg">
      ...
      {/* PREENCHER: substitua por screenshot real do painel Umbler */}
...
function GitMock() {
  return (
    <div className="w-full overflow-hidden rounded-2xl border border-border bg-neutral-950 p-5 font-mono shadow-lg">
      {/* PREENCHER: substitua por screenshot real ou animação do deploy via Git */}
    ...
    <main className="bg-neutral-950 text-foreground">
      ...
      <section className="px-6 py-24 bg-neutral-950">
        <div className="mx-auto max-w-[1100px]">
          <p className="eyebrow text-center">Infraestrutura</p>
        ...
        columns={[
          {
            title: 'Produtos',
            links: [
              { label: 'Hospedagem', href: '/hosting' },
              { label: 'Umbler Talk', href: '/talk' },
              { label: 'Umbler Mail', href: '/mail' },
            ],
          },
          {
            title: 'Recursos',
